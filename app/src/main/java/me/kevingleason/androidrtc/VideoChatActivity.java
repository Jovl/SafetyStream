...
//    private String imei = telephonyManager.getDeviceId();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String frontFacingCam = VideoCapturerAndroid.getNameOfFrontFacingDevice();
        final String backFacingCam = VideoCapturerAndroid.getNameOfBackFacingDevice();
        ...
        this.pnRTCClient.listenOn("Jeremiah");
        ...
        LocationListener locationListener = new LocationListener() {
            public void onLocationChanged(final Location location) {
                ...
                // pubnub.publish("my_channel", message, new Callback() {});
                try {
            ...
            public void onStatusChanged(String provider, int status, Bundle extras) {
                System.out.println(provider.toString() + " Changed");
            }

            public void onProviderEnabled(String provider) {
                System.out.println(provider.toString() + " Enabled");
            }

            public void onProviderDisabled(String provider) {
                System.out.println(provider.toString() + " Disabled");
            }
        };
